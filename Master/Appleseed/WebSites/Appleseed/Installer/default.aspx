        ...
        <table style="height: 100%; width: 100%" align="center">
            <tr>
                <td align="center" valign="middle">
                    <table cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border: solid 1px #999999; height: 525; width: 100%">
                        <tbody>
                            <tr>
                                <td colspan="2" valign="top" height="75" background="images/installer_top_bg.png"
                                    style="background-repeat: repeat-x; color: #fff; font-size: 20px; padding: 10px;">Appleseed.Portal Web Installer
                                </td>
                            </tr>
                            <tr>
                                <td valign="top" style="width: 200px">
                                    <div align="left" style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 10px;">
                                        ...
                                        <div class="<%=StepClass(WizardPanel.UserInformation)%>">
                                            User Information
                                        </div>
                                ...
                                <td valign="top">
                                    <div style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 0px">
                                        <asp:Panel ID="PreInstall" runat="server" Visible="false">
                                            ...
                                            <div class="wizardsection">
                                                <ul>
                                                    <li style="margin-bottom: 8px;">
                                                        ...
                                                        <div>
                                                            Version 4.0 of the .NET framework must be installed
                                                        </div>
                                                        <div>
                                                            <a href="http://www.asp.net/Default.aspx?tabindex=0&tabid=1" target="_blank">Get help
                                                            installing the .NET framework</a>
                                                        </div>
                                                    </li>
                                                    <li style="margin-bottom: 8px;">
                                                        <div class="bold">
                                                        ...
                                                        <div>
                                                            IIS or compatible web server software must be installed
                                                        </div>
                                                        <div>
                                            ...
                                            <div class="wizardsectionheader">
                                                <strong>Environment Check (for user <%=  System.Environment.UserDomainName + @"\" + System.Environment.UserName %>):</strong>
                                            </div>
                                            <div class="wizardsection">
                                                <ul>
                                                    <li style="margin-bottom: 8px;">
                                                        <div class="bold">
                                                            ...
                                                            <asp:Literal EnableViewState="False" ID="lblAspNetVersion"
                                                                runat="server" />
                                                        </div>
                                                    </li>
                                                    <li style="margin-bottom: 8px;">
                                                        <div class="bold">
                                                            Web.Config :
                                                            <asp:Literal EnableViewState="False" ID="lblWebConfigWritable" runat="server" />
                                                        </div>
                                                    </li>
                                                    <li style="margin-bottom: 8px;">
                                                        <div class="bold">
                                                            RB Logs Directory :
                                                            <asp:Literal EnableViewState="False" ID="lblLogsDirWritable"
                                                                runat="server" />
                                                        </div>
                                                    </li>
                                                    <li style="margin-bottom: 8px;">
                                                        <div class="bold">
                                                            Portals Directory :
                                                            <asp:Literal EnableViewState="False" ID="lblPortalsDirWritable"
                                                                runat="server" />
                                                        </div>
                                                    </li>
                                                </ul>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                ...
                                                <tr>
                                                    <td valign="top" align="right" colspan="2">
                                                        <iframe frameborder="1" scrolling="auto" src="LICENSE-2.0.html" height="300" width="680"></iframe>
                                                    </td>
                                                </tr>
                                            </table>
                                            <br>
                                        ...
                                        <asp:Panel ID="ConnectToDb" runat="server" Visible="false">
                                            <div class="mainTitle">
                                                Appleseed Database Login
                                            </div>
                                            <div class="wizardsection">
                                                <div>
                                                    Enter the database login that Appleseed will use to connect to the database.
                                                </div>
                                                <div style="color: red;">
                                                    <asp:Literal EnableViewState="False" ID="lblErrMsgConnect" runat="server" />
                                                </div>
                                        ...
                                        <asp:Panel ID="SelectDb" runat="server" Visible="false">
                                            ...
                                            <div class="wizardsection">
                                                <div>
                                                    Choose the database where you would like to to install Appleseed Portal.
                                                </div>
                                                <div style="padding-left: 20px; padding-top: 20px">
                                                    <div style="padding-left: 20px; padding-top: 10px; color: red">
                                                        <asp:Literal EnableViewState="False" ID="lblErrMsg" runat="server" />
                                                    </div>
                                        ...
                                        <asp:Panel ID="SiteInformation" runat="server" Visible="false">
                                            ...
                                            <div class="wizardsection">
                                                <table cellpadding="2" cellspacing="0" border="0">
                                                    <tr>
                                                        <td align="left" valign="top">Site Title Prefix:
                                                        </td>
                                                        <td align="left">
                                                        ...
                                                        <td width="50%" nowrap="nowrap">example: My Site - . This will make all your page titles: "My Site - Page Name"
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="wizardsection">
                                                <table cellpadding="2" cellspacing="0" border="0">
                                                    <tr>
                                                        <td align="left" valign="top" width="100">SMTP Server:
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td align="left" valign="top" width="100">Email From:
                                                        </td>
                                                        <td align="left">
                                                        ...
                                                        <td valign="top">The Email From address is used on all outgoing messages from the Portal.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                        ...
                                        <asp:Panel ID="Install" runat="server" Visible="false">
                                            ...
                                            <div class="wizardsection">
                                                <table cellpadding="2" cellspacing="0" border="0">
                                                    <tr>
                                                        <td align="left">You are about to write configuration file and run db scripts.
                                                        <br />
                                        ...
                                        <asp:Panel ID="UserInformation" runat="server" Visible="false">
                                            ...
                                            <div class="wizardsection">
                                                <div style="color: red;">
                                                    <asp:Literal EnableViewState="False" ID="ltrUserInfoErr" runat="server" />
                                                </div>
                                                ...
                                                <div style="padding-left: 20px; padding-top: 20px">
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox CssClass="dataentry" ID="txtFullName" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">Username / Email:
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox CssClass="dataentry" ID="txtUserName" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">Password:
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox CssClass="dataentry" ID="txtPassword" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">Re-enter Password:
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox CssClass="dataentry" ID="txtPassword2" runat="server"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            ...
                                            <asp:Repeater ID="lstMessages" runat="server">
                                                <HeaderTemplate>
                                                    <table class="err" width="580px" border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <th class="err" width="100px">Module
                                                            </th>
                                                            <th class="err">Message
                                                            </th>
                                                        </tr>
                                                </HeaderTemplate>
                                                <ItemTemplate>
