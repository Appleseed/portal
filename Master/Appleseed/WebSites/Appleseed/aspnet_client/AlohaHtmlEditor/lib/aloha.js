...
(function (global) {
	...
	function getPluginLoadConfig(plugins) {
		...
		for (i = 0; i < plugins.length; i++) {
			...
			if (bundles[bundleName]) {
			    ...
			    bundlePath = basePath + '/aspnet_client/AlohaHtmlEditor/plugins/' + bundleName;
			}
	...
	function load() {
		...
		var defaultPaths = {
		    jquery: '/aspnet_client/AlohaHtmlEditor/lib/vendor/jquery-1.7.2-aloha',
		    jqueryui: '/aspnet_client/AlohaHtmlEditor/lib/vendor/jquery-ui-1.9.0.custom-aloha'
		};

		var browserPaths = {
		    PubSub: '/aspnet_client/AlohaHtmlEditor/lib/vendor/pubsub/js/pubsub-unminified',
		    'Class': '/aspnet_client/AlohaHtmlEditor/lib/vendor/class',
		    RepositoryBrowser: '/aspnet_client/AlohaHtmlEditor/lib/vendor/repository-browser/js/repository-browser-unminified',
		    jstree: '/aspnet_client/AlohaHtmlEditor/lib/vendor/jquery.jstree',              // Mutates jquery
		    jqgrid: '/aspnet_client/AlohaHtmlEditor/lib/vendor/jquery.jqgrid',              // Mutates jquery
		    'jquery-layout': '/aspnet_client/AlohaHtmlEditor/lib/vendor/jquery.layout-1.3.0-rc29.14',     // Mutates jquery
		    'jqgrid-locale-en': '/aspnet_client/AlohaHtmlEditor/lib/vendor/grid.locale.en', // Mutates jqgrid
		    'jqgrid-locale-de': '/aspnet_client/AlohaHtmlEditor/lib/vendor/grid.locale.de', // Mutates jqgrid
		    'repository-browser-i18n-de': '/aspnet_client/AlohaHtmlEditor/lib/vendor/repository-browser/js/repository-browser-unminified',
		    'repository-browser-i18n-en': '/aspnet_client/AlohaHtmlEditor/lib/vendor/repository-browser/js/repository-browser-unminified'
		};
