<%@ Page Language="C#" CodeBehind="HtmlVersonHistory.aspx.cs" Inherits="Appleseed.DesktopModules.CommunityModules.HTMLDocument.HtmlVersonHistory" MasterPageFile="~/Shared/ModalMaster.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div>
        <p>
            <asp:Button ID="btnCompareAndMarge" Text="Companre and Merge" runat="server" OnClientClick="return CheckVersionSelection();" OnClick="btnCompareAndMarge_Click" />
