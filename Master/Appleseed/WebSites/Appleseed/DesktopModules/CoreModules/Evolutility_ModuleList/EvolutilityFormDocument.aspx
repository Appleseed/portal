<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EvolutilityFormDocument.aspx.cs" Inherits="Appleseed.DesktopModules.CoreModules.Evolutility_ModuleList.EvolutilityFormDocument" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <p>
                <EVOL:UIServer ID="evoFormDocument" runat="server" DataIsMetadata="true"
                    ...
                    Width="100%" XMLfile="/aspnet_client/evolutility/XML/evoDoc_Form.xml" />
            </p>
        </div>
    </form>
</body>
