...
<div style="width: 100%">
    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="col-md-6">
                <asp:TextBox ID="txtFriendlyURL" CssClass="FixTop" runat="server" Width="265" />
                <asp:Label ID="lblFriendlyExtension" runat="server" />
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-9">
            <div class="col-md-9">
                <asp:Button ID="btnSave" Text="Save" CssClass="buttonMargin" runat="server" OnClick="btnSave_Click" />
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <asp:GridView ID="gdPages" runat="server" Width="100%" class="updatedelete" AutoGenerateColumns="false" CellSpacing="1" BorderColor="Black" OnRowEditing="GdPages_RowEditing"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderStyle-CssClass="field-2" ItemStyle-CssClass="field-2" HeaderText="Full Page Path">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderStyle-CssClass="field-3" ItemStyle-CssClass="field-3" HeaderText="Friendly Url">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="txtFriendlyUrl" runat="server" Width="90%" Text='<%# Eval("FriendlyUrl") %>'></asp:TextBox> <asp:RequiredFieldValidator ID="rqfvFriendlyUrl" runat="server" ControlToValidate="txtFriendlyUrl"  ValidationGroup="EditFriendlyUrl" ErrorMessage="*" ></asp:RequiredFieldValidator>
                    </EditItemTemplate>
                </asp:TemplateField>

                <asp:CommandField ShowEditButton="true" ButtonType="Button" ValidationGroup="EditFriendlyUrl" ControlStyle-CssClass="CommandButton" runat="server" />
