<%@ Page Language="C#" AutoEventWireup="true" Inherits="Appleseed.Content.Web.Modules.FileBrowser"
...
<body>
    <form id="form1" runat="server">
        ...
        <input id="HF_CustomRoots" type="hidden" runat="server"
            ...
            data-roots-folders=""
            data-roots-imagefolder="/DesktopModules/CoreModules/FileBrowser/img/32" />
        <div>
            <iz:FileManager ID="FileManager1" runat="server" Height="480" Width="570" ImagesFolder="~/DesktopModules/CoreModules/FileBrowser/img/cmd"
    ...
    <script src="/DesktopModules/CoreModules/FileBrowser/js/FileManager.min.js"></script>
    <script>
        var uploader;
            ...
            switch (obj.command) {
                case 'showfile':
                    ...
                    if (isImage) {
                        ...
                        //alert("File type is not supported to view");
                    }
                    break;
                case 'editfile':
                    ...
                    //console.log('editableFiles', editableFiles);
                    // var isEditable = (['.cshtml', '.txt', '.css', '.js', '.html', '.config']).indexOf(extension) != -1;
                    ...
                    if (isEditable) {
                        ...
                        $dialog.find('#ifrmEditFile').attr('src', '/DesktopModules/CoreModules/FileBrowser/EditFile.aspx?filepath=' + fName);
                        $dialog.modal();
                    } else {
