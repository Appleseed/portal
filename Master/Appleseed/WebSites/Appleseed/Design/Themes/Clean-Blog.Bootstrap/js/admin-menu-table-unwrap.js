...
$(document).ready(function () {
    ...
    $('.admin-menu-list').addClass('nav navbar-nav ');                                              //Add nav classes to right admin navbar
    $('.admin-menu-list').attr('data-role', 'dropdown');
    ...
    $('#Admin_HeaderMenu2').wrap('<ul id="Admin_HeaderMenu" data-role="dropdown" class="nav navbar-nav navbar-right"></ul>');                                                         //Wrap it all in a UL
