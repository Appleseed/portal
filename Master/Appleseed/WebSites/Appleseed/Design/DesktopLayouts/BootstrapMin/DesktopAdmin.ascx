        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="<%= Appleseed.Framework.Settings.Path.ApplicationFullPath %>" class="navbar-brand">
                    <img alt='Appleseed' src='<%=Appleseed.Framework.Settings.Path.ApplicationFullPath  %>/Design/Themes/BootstrapMin/images/brick.png' class='admin-logo' height='16' width='16' />AS
                </a>
