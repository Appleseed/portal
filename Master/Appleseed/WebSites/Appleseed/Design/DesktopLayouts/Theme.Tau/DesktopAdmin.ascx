...
<script runat="server">
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        foreach (TreeNode item in this.asSiteTree.Nodes)
        {
            ...
            {
                sbrMenu.AppendLine("<li class=\"dropdown dropdown-submenu\"><a href=" + item.NavigateUrl + " class=\"dropdown-toggle\">" + item.Text + "</a>");
                RenderSubLinks(item);
        ...
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a href="/1" class="navbar-brand">
                    <img alt='Appleseed' src='/Design/Themes/Theme.Tau/images/brick.png' class='admin-logo' height='16' width='16' />AS
                </a>
