            ...
            <div class="navbar-header">
              <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".userMenu">
                ...
                <a href="<%= Appleseed.Framework.Settings.Path.ApplicationFullPath %>" class="navbar-brand">
                    <img alt='Appleseed' src='<%=Appleseed.Framework.Settings.Path.ApplicationFullPath  %>/Design/Themes/Cerulean.Bootstrap/images/brick.png' class='admin-logo' height='16' width='16' />AS
                </a>
                <ul id="left_admin_menu" class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="<%= Appleseed.Framework.Settings.Path.ApplicationFullPath %>/100" class="dropdown-toggle"> <span>Administration</span></a>
