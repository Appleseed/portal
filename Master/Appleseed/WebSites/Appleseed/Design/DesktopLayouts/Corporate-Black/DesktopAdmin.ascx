...
<div id="as-admin-bar" >
      <div class="quicklinks">
        ...
        <li id="admin-avatar" class="menupop">
          <a href="<%= Appleseed.Framework.Settings.Path.ApplicationFullPath %>"><span><img alt='Appleseed' src='<%=Appleseed.Framework.Settings.Path.ApplicationFullPath  %>/images/brick.png' class='avatar avatar-32 photo' height='32' width='32' />Appleseed Portal</span></a>
                ...
                <li class=""></li>                      
                        ...
                        <li class=""><a href="/155">File Manager</a></li> 
